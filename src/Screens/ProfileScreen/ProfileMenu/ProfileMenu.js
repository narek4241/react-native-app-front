// #task turn 'class component back to 'function component (for mastering)
      ...
      <View style={styles.container}>
        ...
        >
          ...
          <View style={[styles.profileHeader_content, styles.centerFlex]}>
            <View
              style={[styles.centerFlex, styles.profileHeader_content_fullname]}
            >
              <Text
                numberOfLines={1}
        ...
        <View style={styles.profileMenu}>
          ...
          >
            <View style={styles.profileMenu_item_heading}>
              <Text style={styles.profileMenu_item_heading_text}>My Posts</Text>
            </View>
            <View style={[styles.profileMenu_item_other, styles.centerFlex]}>
          ...
          >
            <View style={styles.profileMenu_item_heading}>
              <Text style={styles.profileMenu_item_heading_text}>Settings</Text>
            </View>
            <View style={[styles.profileMenu_item_other, styles.centerFlex]}>
              <View style={styles.profileMenu_item_other_number}>
                <Text style={styles.profileMenu_item_other_number_text}></Text>
              </View>
              <View
                style={[
                  styles.profileMenu_item_other_button,
